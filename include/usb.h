...
#define UNFL_USB_H
    ...
    *********************************/
    ...
    EXTERN_C void usb_write(int datatype, const void* data, int size);
    ...
    EXTERN_C unsigned long usb_poll();
    ...
    EXTERN_C void usb_read(void* buffer, int size);
    ...
    EXTERN_C void usb_skip(int nbytes);
    ...
    EXTERN_C void usb_rewind(int nbytes);
