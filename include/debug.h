...
#define UNFL_DEBUG_H
    ...
    *********************************/
        ...
        EXTERN_C void debug_initialize();
        ...
        EXTERN_C void debug_printf(const char* message, ...);
    ...
    ==============================*/
        ...
        EXTERN_C void debug_vprintf(const char* message, va_list args);
        ...
        EXTERN_C void debug_dumpbinary(void* file, int size);
        ...
        EXTERN_C void debug_screenshot();
        ...
        EXTERN_C void debug_pollcommands();
        ...
        EXTERN_C void debug_addcommand(char* command, char* description, char*(*execute)());
        ...
        EXTERN_C void debug_parsecommand(void* buffer);
        ...
        EXTERN_C int debug_sizecommand();
        ...
        EXTERN_C void debug_printcommands();

        
        // Ignore this, use the macro instead
        EXTERN_C void _debug_assert(const char* expression, const char* file, int line);
