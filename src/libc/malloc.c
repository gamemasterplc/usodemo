...
//Nintendo 64 lacks these headers
#define LACKS_UNISTD_H
#define LACKS_SYS_PARAM_H
#define LACKS_SYS_MMAN_H
//Nintendo 64 also lacks mmap
#define HAVE_MMAP 0

//Export all public symbols in this file
...
#if __STD_C
#include <PR/ultratypes.h>   /* for size_t */
#else
#include <sys/types.h>
#endif
...
//Standard C includes that don't exist on n64
...
//No failure action for malloc on Nintendo 64
...
#if __STD_C
//int is used as a replacement for ptrdiff_t on n64
...
/*
  ...
  declared as "intptr_t", and sometimes "size_t").  It doesn't much
...
//Terminate symbol export in this file
